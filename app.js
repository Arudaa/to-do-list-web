          ...
          <div class="toolbar-container">
            <div class="toolbar">
              <img class="toolbar-color" data-id=${
                note.id
              } src="https://fonts.gstatic.com/s/i/materialicons/palette/v7/24px.svg">
              <img data-id=${
                note.id
              } class="toolbar-delete" src="https://fonts.gstatic.com/s/i/materialicons/delete/v7/24px.svg">
            </div>
          </div>
        </div>
     `
